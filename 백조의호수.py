...
#########문제풀이###############################################
# 1. 입력에서는 백조의 위치를 저장하고 얼음이아니라면 waterQ에 좌표저장
# 2. 백조 한마리를 최대한 움직인다.
# 2-1. 물에 인접한 얼음의 좌표는 NextQ에 입력, 현재 물인 지점 혹은 다른
# 백조가 있는 지점만 Q에 넣어준다 (다 방문처리)
# 2-2. 다른 백조 만나면 경과 일수 출력하며 종료
# 3. 안만나면 얼음녹이고 날짜더하고 2번 다시
###############################################################
import sys
from collections import deque
